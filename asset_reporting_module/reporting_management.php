    ...
    <hr class="sidebar-divider">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="reporting_management.php" class="active">
            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <table class="table datatable">
                        ...
                        <tr>
                            <td><?= htmlspecialchars($report['asset']); ?></td>
                            <td><?= htmlspecialchars($report['report_type']); ?></td>
                            <td><?= htmlspecialchars($report['reported_by']); ?></td>
                            <td><?= date('Y/m/d', strtotime($report['date_reported'])); ?></td>
                                <td>
                            ...
                            <td>
                            <button class="btn btn-sm btn-info view-btn" data-id="<?= $report['id']; ?>">View</button>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            document.querySelectorAll(".view-btn").forEach(button => {
                button.addEventListener("click", function () {
                    ...
                    fetch("get_reports.php?id=" + reportId) 
